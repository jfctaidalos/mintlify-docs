---
title: 'How to get started with the Media Search API?'
...
Sign up at https://taidalos.com (it’s free, no credit card required, enough free credits to play around with the
application and API)
